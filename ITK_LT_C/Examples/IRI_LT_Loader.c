...
/*
 ...
 Step 1: Enable the ENABLE_FW_UPDATES compile switch in the host library's config.h

 Step 2: 'make output/IRI_LT_Loader'

 Notes:
     - This example requires the ENABLE_FW_UPDATES compile flag,
       so building with out it will fail
     - This example has a separate make target from the other examples,
       so 'make output/IRI_LT_Loader' must be used. Simply
       calling 'make' would skip this example.
*/
...
int main(int argc, char* argv[])
{
    ...
    {
        printf("\n\nUsage:"
                "\n\tIRI_Loader.exe COMx <image_location>\n"
                "where: \n"
